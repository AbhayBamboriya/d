      ...
      <div className="carousel-inner">
        <div className="carousel-item active">
          ...
          <div className="carousel-caption d-none d-md-block">
            <h5>Welcome to A t t e n D e a s e</h5>
  ...
  return (
    ...
    backgroundPosition: 'center',}}>
          ...
          >
            <h1 style={{
            fontStyle:'oblique',
            textDecorationColor: 'linear-gradient(45deg, #ffffff, #000000)' }}>E d u v e r s e</h1>
            <br />
            <h3 style={{fontFamily:'cursive',textDecorationStyle:'initial'}}>Eduverse is an interactive platform where students can mark their attendence , view their attendence
              and Teachers can generate report.</h3>
          </div>
        </div>
      </div>
